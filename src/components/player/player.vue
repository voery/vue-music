            ...
            <div class="normal-player" v-show="fullScreen" @touchstart.once="firstPlay">
                ...
                <div class="middle" @click="changeMiddle">
                    ...
                    <transition name="middleR">
                        ...
                        <div class="lyric-wrapper" v-show="currentShow === 'lyric'">
                ...
                <div class="bottom">
                    ...
                    <div class="operators">
                        <div class="icon i-left">
                            <i class="mode iconfont"  :class="iconMode"  @click="changeMode"></i>
                        </div>
                        <div class="icon i-left">
...
export default {
    ...
    methods: {
        ...
        _getSong (id) {
            ...
            // getSong(id).then((res) => {
            //     this.url = `http://music.163.com/song/media/outer/url?id=${id}.mp3 `//res.data.data[0].url
            // })
        },
        _getLyric (id) {
            if (this.currentLyric) {
